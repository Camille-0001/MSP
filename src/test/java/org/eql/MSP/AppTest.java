...
public class AppTest {
	...
	final Logger LOGGER = Logger.getLogger(AppTest.class.getName());
	
	@Test
	public void test() throws Exception {
		SoapUITestCaseRunner testCaseRunner = new SoapUITestCaseRunner();
		testCaseRunner.setProjectFile("src/test/resources/SOAP-Demo-soapui-project.xml");
		try {
			testCaseRunner.run();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void JunitTest1() throws XmlException, IOException, SoapUIException {
		...
		WsdlProject project = new WsdlProject("src/test/resources/SOAP-Demo-soapui-project.xml");
